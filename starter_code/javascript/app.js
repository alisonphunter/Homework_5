$( document ).ready(function() {
    ...
    //when user changes input in drop down , update background image to what they selected
    //use $.attr() funciton to update html classes
    //get value of user using $.val ()
    //use $.change
...
//add background images here with css (.css background image)
      });
});



      ///////////////////////////////////////////////////// past homework for context
